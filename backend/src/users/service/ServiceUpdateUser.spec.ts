import { IModelUsers, IModelUsersUpdate, IUsersDataList, IUsersDataNoPassword, IUsersDataUpdate, IUsersListFilter } from "../../interfaces/IModelUsers"
...
class FakeModels implements IModelUsersUpdate {
    _data:any = null;
