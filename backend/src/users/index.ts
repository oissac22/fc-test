...
import { ControllerUserDataByPassword, ControllerUserDeleteById, ControllerUserInsertData, ControllerUserUpdateData, ControllerUsersList } from "./controller";
...
// Api.get('/api/v1/users/logindata', new ControllerUserDataByPassword(service))